...
class PHONG{
    constructor(MA_PHONG, TENPHONG, MOTA, GIATIEN, HINHANH, MA_KS, MA_LOAIPHG, MA_KM, MA_LOAIPHG_LOAIPHONG, MA_KM_KHUYENMAI){
...
class PHIEUDATPHG{
    constructor(MA_DP, NGAYDEN, NGAYDI, TRANGTHAI, NGAYDATPHG, THANHTIEN, MA_MGG, MA_ND, MA_PHONG, ORDERCODE, MA_PHONG_PHONG, DACOC, MA_ND_NGUOIDUNG){
        this.MA_DP = MA_DP;
        ...
        this.DACOC = DACOC;
        this.MA_ND_NGUOIDUNG = MA_ND_NGUOIDUNG; // Tên người dùng
    }
}